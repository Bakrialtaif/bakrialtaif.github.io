...
export const arSite: SiteInfo = {
  ...
  role: "مهندس بناء الأنظمة المؤسسية والتحول الرقمي",
  tagline: "أحوّل المشكلات المؤسسية المعقدة إلى أنظمة رقمية عملية، وأقود بناءها وتشغيلها حتى الاستقرار.",
  description:
    "أصمم وأبني الأنظمة المؤسسية والمنتجات الرقمية التي تحول المشكلات التشغيلية المعقدة إلى حلول عملية قابلة للاستخدام والتوسع. أقود العمل من تحليل الاحتياج وإعادة هندسة العمليات، مرورًا ببناء النظام وتأسيس الفريق، وحتى التشغيل والاستقرار وقياس النتائج.",
  heroStatement:
    "مهندس أنظمة مؤسسية وقائد منتجات تقنية يجمع بين فهم الأعمال، هندسة المنتج، بناء الأنظمة، قيادة الفرق، وتشغيل الحلول الرقمية في بيئات حكومية ومؤسسية عالية الاعتماد.",
  location: "السودان",
