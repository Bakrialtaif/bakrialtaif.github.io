...
export const enProjects: Project[] = [
  {
    ...
    responsibilities: ["Participated as a co-founder in turning the idea into an operational product.", "Designed the system architecture and core data flows.", "Developed the main application and backend services.", "Integrated OCR and AI capabilities for data processing."],
    ...
    results: ["Processed more than 1.6M notifications", "Used by more than 95K customers", "Converted notifications and documents into trackable, analyzable data"],
    businessImpact: {
  ...
  },
  {
    ...
    responsibilities: ["Participated with the technical team in developing the platform and government services.", "Contributed to analyzing government transaction procedures and converting them into executable digital flows.", "Served as the first programmer and built the initial version of the platform.", "Contributed to platform operation, technical stability follow-up, and onboarding beneficiary institutions."],
    technologies: ["Web applications", "Integration interfaces", "Databases", "Server operations", "Dashboards"],
    keyFeatures: ["Government integrations", "Data management", "Digital services", "Data exchange interfaces", "Production operations"],
    results: ["Connected more than 40+ government institutions", "Includes more than 78+ digital services", "Received over 155K requests"],
    businessImpact: {
  ...
  },
  {
    ...
    overview: "The system handles the lifecycle of foreigners files and transactions at a public, non-sensitive level, from registration and follow-up to file and permission management.",
    responsibilities: ["Designed the main workflow of the system.", "Developed digital services and databases.", "Implemented permission models suited to the operating environment.", "Enabled operations teams during actual use."],
    technologies: ["Web applications", "Databases", "Application security", "Permissions management", "Operational reports"],
    keyFeatures: ["Foreign resident file management", "Transaction tracking", "Operational permissions", "General reports", "Electronic services"],
    results: ["Managed more than (N)K files", "Digitized a core part of foreigners affairs procedures", "Improved file lifecycle tracking without exposing sensitive operational details"],
    businessImpact: {
  ...
  },
  {
    ...
    responsibilities: ["Designed the booking and appointment management mechanism.", "Developed service interfaces and databases.", "Integrated the service with related systems.", "Tracked the system impact on visitor flow."],
    technologies: ["Web applications", "Databases", "E-services", "Workflow automation", "Usage reports"],
    keyFeatures: ["Appointment management", "Online booking", "Visitor organization", "Operational integrations", "Usage reports"],
    results: ["Completed more than 674K bookings", "Supported more than 3.3M inquiries", "Organized service flow across more than 40+ offices worldwide"],
    businessImpact: {
  ...
  },
  {
    ...
    summary: "An enterprise system for managing resources, workflows, and operations in a private-sector environment.",
    ...
    responsibilities: ["Helped build the system modules.", "Established the IT department.", "Established the team and Sudan branch.", "Converted workflow requirements into system customization."],
    technologies: ["ERP", "HR", "Finance", "Workflow", "CRM", "Inventory"],
    keyFeatures: ["HR", "Finance", "Planning", "Workflow", "Business documents"],
    results: ["Established the IT function", "Helped build the resource management system", "Built a supporting technical team"],
    businessImpact: {
