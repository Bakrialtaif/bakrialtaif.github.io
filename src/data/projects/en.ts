...
export const enProjects: Project[] = [
  ...
  },
  {
    ...
    responsibilities: ["Led development of the platform and government services.", "Analyzed government transaction procedures and converted them into digital flows.", "Operated the platform in production and followed up technical stability.", "Led user training and onboarding for beneficiary institutions."],
